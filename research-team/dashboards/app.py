...
# ## PDF GENERATOR (FIXED CSS) ---
# def md_to_pdf(md_text, filename):
#     ## 1. Convert Markdown to HTML
#     html_content = markdown.markdown(md_text, extensions=['extra', 'smarty', 'nl2br'])

#     ## 2. Symbol replacements for PDF compatibility
#     html_content = html_content.replace('±', '+/-')
#     html_content = html_content.replace('$', '&##36;')
#     html_content = html_content.replace('→', '&rarr;')
#     html_content = html_content.replace('—', '&mdash;')
#     html_content = html_content.replace('–', '&ndash;')
#     html_content = html_content.replace('%', '&##37;')
    
#     ## 3. Enhanced CSS - xhtml2pdf compatible (no ## in strings, use rgb instead)
#     styled_html = f"""
#     <html>
#     <head>
#         <meta charset="UTF-8">
...
#     if pisa_status.err:
#         st.error(f"PDF generation encountered errors. Check console for details.")
